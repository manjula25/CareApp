...
| **4. Implement** | `subagent-driven-development` (loads `tdd`, uses `using-git-worktrees`); `diagnosing-bugs` and `improve-codebase-architecture` as needed | code + tests |
| **5. Verify & review** | `verification-before-completion`, then `code-review` | `verification.md`, `review.md` |
